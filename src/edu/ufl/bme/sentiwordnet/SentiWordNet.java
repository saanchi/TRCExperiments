...
public class SentiWordNet {
	...
	public static void main(String [] args) throws IOException {
		...
		args    = new String[2];
		args[0] = "/home/sanchit/Downloads/project/swn.txt";
		String pathToSWN = args[0];
		SentiWordNet sentiwordnet = new SentiWordNet(pathToSWN);
		
		System.out.println("good#a "+sentiwordnet.extract("2nd", "a"));
		System.out.println("bad#a "+sentiwordnet.extract("apointment", "a"));
		System.out.println("blue#a "+sentiwordnet.extract("sat", "a"));
		System.out.println("blue#n "+sentiwordnet.extract("wondering", "n"));
	}
}